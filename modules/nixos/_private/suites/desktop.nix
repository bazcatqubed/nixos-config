...
in
{
  options.suites.desktop = {
    enable = lib.mkEnableOption "basic desktop-related services and default programs";
    audio.enable = lib.mkEnableOption "audio production setup";
    windows-compatibility.enable = lib.mkEnableOption "Windows compatibility toolkit";
      ...
      (lib.mkIf cfg.audio.enable {
        ...
        environment.profileRelativeSessionVariables =
          let
            ...
            ++ lib.optionals cfg.windows-compatibility.enable [
              "VST"
              "VST3"
            ];
          in
