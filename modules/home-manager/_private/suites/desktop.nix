...
in
{
  options.suites.desktop = {
    ...
    graphics.enable = lib.mkEnableOption "installations of graphics-related apps";
    audio = {
    ...
    documents.enable = lib.mkEnableOption "installations for document-related apps";
  };
    ...
    lib.mkMerge [
      (lib.mkIf cfg.graphics.enable {
        home.packages =
          ...
          [
            ...
            pixieditor # Pixel art wannabe tool.
      ...
      (lib.mkIf cfg.audio.pipewire.enable {
        ...
        home.packages = with pkgs; [
          crosspipe # The Pipewire node editor.
