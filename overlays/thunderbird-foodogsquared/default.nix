    ...
    wrapThunderbird thunderbird-unwrapped {
      extraPolicies = {
        ...
        ExtensionSettings =
          let
            thunderbirdAddon =
              name: "https://addons.thunderbird.net/thunderbird/downloads/latest/${name}/latest.xpi";
            ...
            extensions = {
              ...
              "{e6696d02-466a-11e3-a162-04e36188709b}".installation_url =
                thunderbirdAddon "eds-calendar-integration";
