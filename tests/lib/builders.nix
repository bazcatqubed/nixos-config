...
lib.runTests {
  testsBuilderMakeSampleXDGAssociationList = {
    expr =
      ...
      in
      builtins.readFile "${xdgAssociations}/share/applications/mimeapps.list";
  ...
  testsBuilderMakeSampleDesktopSpecificXDGAssociationList = {
    expr =
      ...
      in
      builtins.readFile "${xdgAssociations}/share/applications/${sampleDesktopName}-mimeapps.list";
    expected = builtins.readFile ./data/fixtures/xdg-mime-sample-desktop-specific-mimeapps.list;
  };
